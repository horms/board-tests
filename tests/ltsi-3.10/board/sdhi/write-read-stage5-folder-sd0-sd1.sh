...
# Make 5 stage folder
mkdir -p $src_dir/src_folder/stage1/stage2/stage3/stage4/stage5
mkdir -p $dst_dir/dst_folder/stage1/stage2/stage3/stage4/stage5

# Real src and dst folder
real_src="$src_dir/src_folder/stage1/stage2/stage3/stage4/stage5"
real_dst="$dst_dir/dst_folder/stage1/stage2/stage3/stage4/stage5"
